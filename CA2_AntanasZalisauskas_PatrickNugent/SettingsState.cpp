...
bool SettingsState::HandleEvent(const sf::Event& event)
{
	...
	for (std::size_t i = 0; i < 1 * (static_cast<int>(PlayerAction::kActionCount)); ++i)
	{
...
void SettingsState::AddButtonLabel(std::size_t index, std::size_t x, std::size_t y, const std::string& text, Context context)
{
	...
	m_binding_buttons[index]->setPosition(400.f * x + 400.f, 50.f * y + 300.f);
	...
	m_binding_labels[index]->setPosition(400.f * x + 620.f, 50.f * y + 315.f);
